...
@UpdateEvent(onExpression = "", updateEventClass = UpdateFillEvent.class, updateParams = {"sharePoll", "remainPoll", "personInfoList", "sharePoll", "weight", "personName"})
public class PersonInfo5Dto extends BaseDto implements Serializable {
    ...
    private List<PersonInfo5Dto> personInfoList;
}
