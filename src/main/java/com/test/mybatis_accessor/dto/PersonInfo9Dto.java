...
@UpdateEvent(onExpression = "", updateEventClass = UpdateAssignEvent.class, updateParams = {"point", "personInfoList", "point", "2", "weight"})
public class PersonInfo9Dto extends BaseDto implements Serializable {
    ...
    private List<PersonInfo9Dto> personInfoList;
}
