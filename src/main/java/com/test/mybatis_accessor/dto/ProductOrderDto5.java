...
@UpdateEvent(onExpression = "#{orderDetails?.size() > 0}", updateEventClass = UpdateMinEvent.class, updateParams = {"totalWeight", "orderDetails", "weight"})
...
public class ProductOrderDto5 extends BaseDto implements Serializable {
