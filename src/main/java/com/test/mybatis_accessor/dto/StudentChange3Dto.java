...
//@PropertyChangeEvent(changeProperties = {"name", "grade"}, triggerOnAnyChanged = true, onChangeExecutor = StudentChangeEvent3.class, updateParams = {"3"})
public class StudentChange3Dto implements Serializable {
