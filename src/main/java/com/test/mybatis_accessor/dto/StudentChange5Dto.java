...
//@PropertyChangeEvent(changeProperties = {"name", "grade"}, triggerOnAnyChanged = false, onChangeExecutor = StudentChangeEvent5.class, updateParams = {"5"})
public class StudentChange5Dto implements Serializable {
