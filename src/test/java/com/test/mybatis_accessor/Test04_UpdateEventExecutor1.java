...
@Slf4j
public class Test04_UpdateEventExecutor1 {
    @Autowired
    private MybatisAccessorService mybatisAccessorService;

    private String namePrefix = "testCase1_";
    ...
    public void Test1() throws MybatisAccessorException {
        ...
        PersonInfoDto personInfo4_1 = PersonInfoDto.builder().personName(testName + "4-1").point(point4_1).deleted(0)
        ...
        PersonInfoDto personInfo4_2 = PersonInfoDto.builder().personName(testName + "4-2").point(point4_2).deleted(0)
        ...
        PersonInfoDto personInfo3_1 = PersonInfoDto.builder().personName(testName + "3-1").point(point3_1).deleted(0)
        ...
        PersonInfoDto personInfo3_2 = PersonInfoDto.builder().personName(testName + "3-2").point(point3_2).deleted(0)
        ...
        PersonInfoDto personInfo3_3 = PersonInfoDto.builder().personName(testName + "3-3").point(point3_3).deleted(0)
        ...
        PersonInfoDto personInfo3_4 = PersonInfoDto.builder().personName(testName + "3-4").point(point3_4).deleted(0)
        ...
        PersonInfoDto personInfo2_1 = PersonInfoDto.builder().personName(testName + "2-1").point(point2_1).deleted(0)
        ...
        PersonInfoDto personInfo2_2 = PersonInfoDto.builder().personName(testName + "2-2").point(point2_2).deleted(0)
        ...
        PersonInfoDto personInfo1_1 = PersonInfoDto.builder().personName(testName + "1-1").point(point1_1).deleted(0)
        ...
        List<PersonInfoDto> Person1_1 = dtoList.stream().filter(x -> (testName + "1-1").equals(x.getPersonName())).collect(Collectors.toList());
        assert(Person1_1.size() == 1);
        List<PersonInfoDto> Person2_1 = dtoList.stream().filter(x -> (testName + "2-1").equals(x.getPersonName())).collect(Collectors.toList());
        assert(Person2_1.size() == 1);
        List<PersonInfoDto> Person2_2 = dtoList.stream().filter(x -> (testName + "2-2").equals(x.getPersonName())).collect(Collectors.toList());
        ...
        List<PersonInfoDto> Person3_1 = dtoList.stream().filter(x -> (testName + "3-1").equals(x.getPersonName())).collect(Collectors.toList());
        assert(Person3_1.size() == 1);
        List<PersonInfoDto> Person3_2 = dtoList.stream().filter(x -> (testName + "3-2").equals(x.getPersonName())).collect(Collectors.toList());
        assert(Person3_2.size() == 1);
        List<PersonInfoDto> Person3_3 = dtoList.stream().filter(x -> (testName + "3-3").equals(x.getPersonName())).collect(Collectors.toList());
        assert(Person3_3.size() == 1);
        List<PersonInfoDto> Person3_4 = dtoList.stream().filter(x -> (testName + "3-4").equals(x.getPersonName())).collect(Collectors.toList());
        ...
        List<PersonInfoDto> Person4_1 = dtoList.stream().filter(x -> (testName + "4-1").equals(x.getPersonName())).collect(Collectors.toList());
        assert(Person4_1.size() == 1);
        List<PersonInfoDto> Person4_2 = dtoList.stream().filter(x -> (testName + "4-2").equals(x.getPersonName())).collect(Collectors.toList());
    ...
    public void Test2() throws MybatisAccessorException {
        ...
        PersonInfoDto personInfo3_5 = PersonInfoDto.builder().personName(testName + "3-5").point(point3_5).deleted(0)
        ...
        PersonInfoDto personInfo2_3 = PersonInfoDto.builder().personName(testName + "2-3").point(point2_3).deleted(0)
