...
import com.test.mybatis_accessor.dto.PersonInfo2Dto;
...
@Slf4j
public class Test04_UpdateEventExecutor2 {
    @Autowired
    private MybatisAccessorService mybatisAccessorService;

    private String namePrefix = "testCase2_";
    ...
    public void Test1() throws MybatisAccessorException {
        ...
        PersonInfo2Dto personInfo4_1 = PersonInfo2Dto.builder().personName(testName + "4-1").point(point4_1).deleted(0)
        ...
        PersonInfo2Dto personInfo4_2 = PersonInfo2Dto.builder().personName(testName + "4-2").point(point4_2).deleted(0)
        ...
        PersonInfo2Dto personInfo3_1 = PersonInfo2Dto.builder().personName(testName + "3-1").point(point3_1).deleted(0)
        ...
        PersonInfo2Dto personInfo3_2 = PersonInfo2Dto.builder().personName(testName + "3-2").point(point3_2).deleted(0)
        ...
        PersonInfo2Dto personInfo3_3 = PersonInfo2Dto.builder().personName(testName + "3-3").point(point3_3).deleted(0)
        ...
        PersonInfo2Dto personInfo3_4 = PersonInfo2Dto.builder().personName(testName + "3-4").point(point3_4).deleted(0)
        ...
        PersonInfo2Dto personInfo2_1 = PersonInfo2Dto.builder().personName(testName + "2-1").point(point2_1).deleted(0)
        ...
        PersonInfo2Dto personInfo2_2 = PersonInfo2Dto.builder().personName(testName + "2-2").point(point2_2).deleted(0)
        ...
        PersonInfo2Dto personInfo1_1 = PersonInfo2Dto.builder().personName(testName + "1-1").point(point1_1).deleted(0)
        ...
        PersonInfo2 mainPersonInfo = mybatisAccessorService.save(personInfo1_1, true, null, false, null);
        ...
        List<PersonInfo2Dto> dtoList = mybatisAccessorService.getDtoListByQueryWrapper(PersonInfo2Dto.class, qw);
        assert(dtoList.size() == 9);

        List<PersonInfo2Dto> Person1_1 = dtoList.stream().filter(x -> (testName + "1-1").equals(x.getPersonName())).collect(Collectors.toList());
        assert(Person1_1.size() == 1);
        List<PersonInfo2Dto> Person2_1 = dtoList.stream().filter(x -> (testName + "2-1").equals(x.getPersonName())).collect(Collectors.toList());
        assert(Person2_1.size() == 1);
        List<PersonInfo2Dto> Person2_2 = dtoList.stream().filter(x -> (testName + "2-2").equals(x.getPersonName())).collect(Collectors.toList());
        ...
        List<PersonInfo2Dto> Person3_1 = dtoList.stream().filter(x -> (testName + "3-1").equals(x.getPersonName())).collect(Collectors.toList());
        assert(Person3_1.size() == 1);
        List<PersonInfo2Dto> Person3_2 = dtoList.stream().filter(x -> (testName + "3-2").equals(x.getPersonName())).collect(Collectors.toList());
        assert(Person3_2.size() == 1);
        List<PersonInfo2Dto> Person3_3 = dtoList.stream().filter(x -> (testName + "3-3").equals(x.getPersonName())).collect(Collectors.toList());
        assert(Person3_3.size() == 1);
        List<PersonInfo2Dto> Person3_4 = dtoList.stream().filter(x -> (testName + "3-4").equals(x.getPersonName())).collect(Collectors.toList());
        ...
        List<PersonInfo2Dto> Person4_1 = dtoList.stream().filter(x -> (testName + "4-1").equals(x.getPersonName())).collect(Collectors.toList());
        assert(Person4_1.size() == 1);
        List<PersonInfo2Dto> Person4_2 = dtoList.stream().filter(x -> (testName + "4-2").equals(x.getPersonName())).collect(Collectors.toList());
        ...
        PersonInfo2Dto dto1_1 = mybatisAccessorService.getDtoById(PersonInfo2Dto.class, Person1_1.get(0).getPersonId(), true, null);
    ...
    public void Test2() throws MybatisAccessorException {
        ...
        QueryWrapper qw = new QueryWrapper<>();
        qw.eq("person_info.person_name",testName + "1-1");

        List<PersonInfo2Dto> dtoList = mybatisAccessorService.getDtoListByQueryWrapper(PersonInfo2Dto.class, qw);
        PersonInfo2Dto dto1_1 = mybatisAccessorService.getDtoById(PersonInfo2Dto.class, dtoList.get(0).getPersonId(), true, null);

        dto1_1.getPersonInfoList().stream().filter(x -> x.getPersonName().equals(testName + "2-1")).forEach(x -> x.setDeleted(1));
        PersonInfo2Dto dto2_2 = dto1_1.getPersonInfoList().stream().filter(x -> x.getPersonName().equals(testName + "2-2")).findAny().get();

        BigDecimal point3_5 = BigDecimal.valueOf(12.34);
        BigDecimal weight3_5 = BigDecimal.valueOf(90.41);
        PersonInfo2Dto personInfo3_5 = PersonInfo2Dto.builder().personName(testName + "3-5").point(point3_5).deleted(0)
        ...
        PersonInfo2Dto personInfo2_3 = PersonInfo2Dto.builder().personName(testName + "2-3").point(point2_3).deleted(0)
                .weight(weight2_3).build();
        personInfo2_3.setCreateUser(6);

        dto1_1.getPersonInfoList().add(personInfo2_3);

        PersonInfo2 mainPersonInfo = mybatisAccessorService.saveOrUpdate(dto1_1, true, null, false, null);
        assert(mainPersonInfo != null);

        dto1_1 = mybatisAccessorService.getDtoById(PersonInfo2Dto.class, dto1_1.getPersonId(), true, null);
        ...
        dto2_2 = mybatisAccessorService.getDtoById(PersonInfo2Dto.class, dto2_2.getPersonId(), true, null);
    ...
    public void Test3() throws MybatisAccessorException {
        ...
        QueryWrapper qw = new QueryWrapper<>();
        qw.likeRight("person_info.person_name",testName);
        qw.likeLeft("person_info.person_name","1-1");

        List<PersonInfo2Dto> dtoList = mybatisAccessorService.getDtoListByQueryWrapper(PersonInfo2Dto.class, qw);
        Set<Serializable> idList = dtoList.stream().map(x -> x.getPersonId()).collect(Collectors.toSet());
        assert(idList.size() == 1);
        mybatisAccessorService.deleteByIds(PersonInfo2Dto.class, idList, true, null, false, null);

        QueryWrapper qw2 = new QueryWrapper<>();
        qw2.likeRight("person_info.person_name",testName);
        dtoList = mybatisAccessorService.getDtoListByQueryWrapper(PersonInfo2Dto.class, qw);
