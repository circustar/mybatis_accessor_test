...
public class Test04_UpdateEventExecutor3 {
    ...
    public void test1() throws MybatisAccessorException {
        ...
        ProductOrderDto orderDto = ProductOrderDto.builder().amount(amount)
    ...
    public void test2() throws MybatisAccessorException {
        ...
        ProductOrderDto orderDto = mybatisAccessorService.getDtoById(ProductOrderDto.class, dtoList.get(0).getOrderId(), true ,null);;
        ...
        ProductOrderDto po = mybatisAccessorService.getDtoById(ProductOrderDto.class, orderDto.getOrderId(), true ,null);
        assert(po!= null);
