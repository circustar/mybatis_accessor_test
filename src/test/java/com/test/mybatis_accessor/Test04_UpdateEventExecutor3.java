...
public class Test04_UpdateEventExecutor3 {
    ...
    public void test2() throws MybatisAccessorException {
        ...
        ProductOrderDto orderDto = mybatisAccessorService.getDtoById(ProductOrderDto.class, dtoList.get(0).getOrderId(), null);;
        ...
        ProductOrderDto po = mybatisAccessorService.getDtoById(ProductOrderDto.class, orderDto.getOrderId(), null);
        assert(po!= null);
