...
public class Test05_UpdateEventExecutorSql1 {
    ...
    public void Test0() throws MybatisAccessorException {
        ...
        dtoList = mybatisAccessorService.getDtoListByQueryWrapper(PersonInfo3Dto.class, qw);
    ...
    public void Test1() throws MybatisAccessorException {
        ...
        PersonInfo3Dto personInfo4_1 = PersonInfo3Dto.builder().personName(testName + "4-1").point(point4_1).deleted(0)
        ...
        PersonInfo3Dto personInfo4_2 = PersonInfo3Dto.builder().personName(testName + "4-2").point(point4_2).deleted(0)
        ...
        PersonInfo3Dto personInfo3_1 = PersonInfo3Dto.builder().personName(testName + "3-1").point(point3_1).deleted(0)
        ...
        PersonInfo3Dto personInfo3_2 = PersonInfo3Dto.builder().personName(testName + "3-2").point(point3_2).deleted(0)
        ...
        PersonInfo3Dto personInfo3_3 = PersonInfo3Dto.builder().personName(testName + "3-3").point(point3_3).deleted(0)
        ...
        PersonInfo3Dto personInfo3_4 = PersonInfo3Dto.builder().personName(testName + "3-4").point(point3_4).deleted(0)
        ...
        PersonInfo3Dto personInfo2_1 = PersonInfo3Dto.builder().personName(testName + "2-1").point(point2_1).deleted(0)
        ...
        PersonInfo3Dto personInfo2_2 = PersonInfo3Dto.builder().personName(testName + "2-2").point(point2_2).deleted(0)
        ...
        PersonInfo3Dto personInfo1_1 = PersonInfo3Dto.builder().personName(testName + "1-1").point(point1_1).deleted(0)
        ...
        List<PersonInfo3Dto> Person1_1 = dtoList.stream().filter(x -> (testName + "1-1").equals(x.getPersonName())).collect(Collectors.toList());
        assert(Person1_1.size() == 1);
        List<PersonInfo3Dto> Person2_1 = dtoList.stream().filter(x -> (testName + "2-1").equals(x.getPersonName())).collect(Collectors.toList());
        assert(Person2_1.size() == 1);
        List<PersonInfo3Dto> Person2_2 = dtoList.stream().filter(x -> (testName + "2-2").equals(x.getPersonName())).collect(Collectors.toList());
        ...
        List<PersonInfo3Dto> Person3_1 = dtoList.stream().filter(x -> (testName + "3-1").equals(x.getPersonName())).collect(Collectors.toList());
        assert(Person3_1.size() == 1);
        List<PersonInfo3Dto> Person3_2 = dtoList.stream().filter(x -> (testName + "3-2").equals(x.getPersonName())).collect(Collectors.toList());
        assert(Person3_2.size() == 1);
        List<PersonInfo3Dto> Person3_3 = dtoList.stream().filter(x -> (testName + "3-3").equals(x.getPersonName())).collect(Collectors.toList());
        assert(Person3_3.size() == 1);
        List<PersonInfo3Dto> Person3_4 = dtoList.stream().filter(x -> (testName + "3-4").equals(x.getPersonName())).collect(Collectors.toList());
        ...
        List<PersonInfo3Dto> Person4_1 = dtoList.stream().filter(x -> (testName + "4-1").equals(x.getPersonName())).collect(Collectors.toList());
        assert(Person4_1.size() == 1);
        List<PersonInfo3Dto> Person4_2 = dtoList.stream().filter(x -> (testName + "4-2").equals(x.getPersonName())).collect(Collectors.toList());
    ...
    public void Test2() throws MybatisAccessorException {
        ...
        PersonInfo3Dto personInfo3_5 = PersonInfo3Dto.builder().personName(testName + "3-5").point(point3_5).deleted(0)
        ...
        PersonInfo3Dto personInfo2_3 = PersonInfo3Dto.builder().personName(testName + "2-3").point(point2_3).deleted(0)
